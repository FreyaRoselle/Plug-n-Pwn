...
ESP32-S3-Based Programmable USB HID Platform<br>
Academic & Laboratory Research Project
</p>

<p align="center">
<img src="images/ESP32.jpg" width="420">
</p>
...
<p>
Plug’n’Pwn is an ESP32-S3-based programmable USB Human Interface Device (HID) platform developed to study and demonstrate
...
<ul>
<li>ESP32-S3 microcontroller (native USB support)</li>
...
<p style="color:#8b949e;">
The ESP32-S3 was selected due to its native USB capability, enabling reliable HID emulation without external USB controllers.
</p>
